...
_OUTFILE = flags.DEFINE_string(
  'outfile', None, 'Where we should write the data (as csv) to. If not set, we '
...
def main(argv: list[str]) -> None:
  ...
  while current_timestamp < end_timestamp:
    ...
    logging.info('Querying station %d from %s to %s', _PURPLEAIR_STATION_ID.value, current_timestamp, end)
